...
class ZkMachine(models.Model):
    ...
    # _inherit = "hr.attendance" # have to comment for now to downlaod attenadnce 
    _description = "ZK Machine Attendance"

    @api.constrains("check_in", "check_out", "employee_id")
    def _check_validity(self):
        """overriding the __check_validity function for employee attendance."""
    employee_id = fields.Many2one("hr.employee", string="Employee") # adding new field for downlaading attendance
    device_id = fields.Char(string="Biometric Device ID")
