  ...
  typeof define === "function" && define.amd
    ...
    ? (module.exports = function(e, t) {
        return (
          void 0 === t &&
            (t =
              typeof window !== "undefined" ? require("jquery") : require("jquery")(e)),
          n(t),
          t
        );
      })
      ...
      return (
        (e && e.requirejs) ||
          ...
          (o = function(e, t, n, r) {
            var i,
              ...
              d = [],
              p = typeof n;
            if (((c = S((r = r || e))), p == "undefined" || p == "function")) {
              for (
                t = !t.length && n.length ? ["require", "exports", "module"] : t, l = 0;
                l < t.length;
                l += 1
              )
                if ((o = (a = f(t[l], c)).f) === "require") d[l] = g.require(e);
                else if (o === "exports") (d[l] = g.exports(e)), (u = !0);
                else if (o === "module") i = d[l] = g.module(e);
              ...
              for (var t in e) {
                ...
                if (n.length !== 1) {
                  for (var i = 0; i < n.length; i++) {
                    var o = n[i];
                    (o = o.substring(0, 1).toLowerCase() + o.substring(1)) in r ||
                      (r[o] = {}),
        ...
        e.define("select2/results", ["jquery", "./utils"], function(h, f) {
          ...
          return (
              ...
              this.data.current(function(e) {
                ...
                t.$results
                  ...
                  .each(function() {
                    ...
                    (t.element == null && h.inArray(n, r) > -1)
            ...
            (r.prototype.option = function(e) {
              ...
              for (var i in (((e.element != null && r.call(e.element, ":disabled")) ||
        ...
        e.define("select2/selection/base", ["jquery", "../utils", "../keys"], function(
          ...
          return (
            ...
            (o.prototype.render = function() {
              ...
              return (
                (this._tabindex = 0),
                r.GetData(this.$element[0], "old-tabindex") != null
                  ...
                  if (n.length !== 0) {
                    ...
                    if ((this.trigger("clear", o), o.prevented)) this.$element.val(i);
                      ...
                      for (var s = 0; s < r.length; s++)
                        if (
                          ((o = {data: r[s]}), this.trigger("unselect", o), o.prevented)
                        )
              ...
              e.call(this, t, n),
                t.on("*", function(e, t) {
                  if (s.inArray(e, i) !== -1) {
                    ...
                    r.$element.trigger(n),
                      s.inArray(e, o) !== -1 && (t.prevented = n.isDefaultPrevented());
                  }
                });
            }),
            e
        ...
        e.define("select2/data/select", ["./base", "../utils", "jquery"], function(
          ...
          return (
            ...
            (n.prototype.unselect = function(i) {
              ...
              if (this.$element.prop("multiple")) {
                if (((i.selected = !1), l(i.element).is("option")))
                  return (
                    (i.element.selected = !1), void this.$element.trigger("change")
                  );
                this.current(function(e) {
                  for (var t = [], n = 0; n < e.length; n++) {
                    var r = e[n].id;
                    r !== i.id && l.inArray(r, t) === -1 && t.push(r);
                  }
                  o.$element.val(t), o.$element.trigger("change");
                });
              }
            ...
            (n.prototype.item = function(e) {
              var t = {};
              if ((t = a.GetData(e[0], "data")) != null) return t;
              if (e.is("option"))
                t = {
                  id: e.val(),
                  text: e.text(),
        ...
        e.define("select2/data/ajax", ["./array", "../utils", "jquery"], function(
          ...
          return (
            ...
            (n.prototype.query = function(n, r) {
              ...
              typeof t.url === "function" && (t.url = t.url.call(this.$element, n)),
        ...
        e.define("select2/data/tags", ["jquery"], function(u) {
          function e(e, t, n) {
            ...
            if (
              (void 0 !== o && (this.insertTag = o), e.call(this, t, n), u.isArray(r))
            )
              for (var s = 0; s < r.length; s++) {
                var a = r[s],
                ...
                c.term != null && c.page == null
                  ? e.call(this, c, function e(t, n) {
                      for (var r = t.results, i = 0; i < r.length; i++) {
                        var o = r[i],
                          s = o.children != null && !e({results: o.children}, !0);
                        if (
                          (o.text || "").toUpperCase() ===
                            (c.term || "").toUpperCase() ||
                          s
            ...
            (e.prototype.tokenizer = function(e, t, n, r) {
              for (
                ...
                if (d.inArray(l, i) !== -1) {
                  ...
                  u != null ? (r(u), (o = o.substr(s + 1) || ""), (s = 0)) : s++;
                } else s++;
              }
              return {term: o};
            }),
          ...
          return (
            ...
            (e.prototype._checkIfMaximumSelected = function(e, n) {
              ...
              this.current(function(e) {
                ...
                r.maximumSelectionLength > 0 && t >= r.maximumSelectionLength
          ...
          return (
            ...
            (e.prototype._positionDropdown = function() {
              ...
              (d.top -= h.top),
                ...
                (r == "above" || (t && r !== "below")) && (d.top = o.top - h.top - s),
                r != null &&
                  (this.$dropdown
          ...
          return (
            ...
            (e.prototype._handleSelectOnClose = function(e, t) {
              ...
              if (!(r.length < 1)) {
                ...
                (i.element != null && i.element.selected) ||
          ...
          function(
            ...
            return (
              (n.prototype.apply = function(e) {
                if ((e = c.extend(!0, {}, this.defaults, e)).dataAdapter == null) {
                  if (
                    (e.ajax != null
                      ? (e.dataAdapter = w)
                      : e.data != null
                  ...
                  matcher: function e(t, n) {
                    ...
                    if (n.children && n.children.length > 0) {
                      for (
                        ...
                        e(t, n.children[i]) == null && r.children.splice(i, 1);
                      return r.children.length > 0 ? r : e(t, r);
                    }
              ...
              (n.prototype._resolveLanguage = function(e) {
                ...
                for (var n = [], r = 0; r < t.length; r++)
                  if (
                    (n.push(t[r]), typeof t[r] === "string" && t[r].indexOf("-") > 0)
                  ) {
                    var i = t[r].split("-")[0];
                    n.push(i);
                  }
          ...
          function(r, d, i, p) {
            function e(e, t) {
              if (
                ...
                t != null && (this.options = i.applyFromElement(this.options, t)),
        ...
        e.define("select2/core", ["jquery", "./options", "./utils", "./keys"], function(
          ...
          var d = function(e, t) {
            u.GetData(e[0], "select2") != null && u.GetData(e[0], "select2").destroy(),
              (this.$element = e),
          ...
          return (
            ...
            (d.prototype._resolveWidth = function(e, t) {
              ...
              if (t != "style")
                return t != "computedstyle" ? t : window.getComputedStyle(e[0]).width;
              var o = e.attr("style");
        ...
        e.define(
          ...
          function(i, e, o, t, s) {
            ...
            return i.fn.select2.defaults == null && (i.fn.select2.defaults = t), o;
          }
        ),
