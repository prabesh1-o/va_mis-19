...
export class TicketKanbanController extends KanbanController {
  setup() {
    super.setup();
    ...
    onWillStart(async () => {
      try {
        ...
        const showButtonBasedOnTickets =
          ticketMenus.length &&
          ticketMenus[0].id !== activeId;
        ...
        this.state.showButton =
          showButtonBasedOnTickets && isAdmin;
...
registry.category("views").add("button_in_kanban", {
  ...
  buttonTemplate: "button_ticket.KanbanView.Buttons",
});